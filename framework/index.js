define(["require", "exports", "./utils/ui-utils", "./utils/ui-application", "./utils/ui-validation", "./utils/ui-event", "./utils/ui-formatters", "./utils/ui-application", "./utils/ui-model", "./components/ui-dialog", "./utils/ui-tree-models", "./utils/ui-http-service", "./utils/ui-validation", "./utils/ui-utils", 'lodash', 'moment', 'numeral', './libs/marked', './libs/phonelib', './data/fileTypes', './data/countries', './data/currencies'], function (require, exports, ui_utils_1, ui_application_1, ui_validation_1, ui_event_1, ui_formatters_1, ui_application_2, ui_model_1, ui_dialog_1, ui_tree_models_1, ui_http_service_1, ui_validation_2, ui_utils_2) {
    "use strict";
